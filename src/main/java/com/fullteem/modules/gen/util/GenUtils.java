 ...
 */
package com.fullteem.modules.gen.util;
...
import com.fullteem.common.mapper.JaxbMapper;
import com.fullteem.common.utils.DateUtils;
import com.fullteem.common.utils.FileUtils;
import com.fullteem.common.utils.FreeMarkers;
import com.fullteem.common.utils.StringUtils;
import com.fullteem.modules.gen.entity.GenCategory;
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			if (!StringUtils.equalsIgnoreCase(column.getName(), "id")
				...
				column.setIsReq("1");//新加   是否入参
				column.setIsRes("1");//新加 是否出参
			}
