 ...
 */
@MyBatisDao
public interface ZhengheCommonImageDao extends CrudDao<ZhengheCommonImage> {
	
	ZhengheCommonImage findByRelevanceId(String relevanceId);

	void delByRelevanceId(String relevanceId);
