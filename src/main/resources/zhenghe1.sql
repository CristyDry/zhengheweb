...
CREATE TABLE `zhenghe_rx` (
  ...
  `patient_name` varchar(20) DEFAULT '' COMMENT '患者名称',
  ...
  `rx_date` datetime DEFAULT NULL COMMENT '开具时间',
  ...
  `employee_number` archar(32) DEFAULT NULL COMMENT '工号',
...
INSERT INTO `sys_dict` VALUES ('481f3e56ab1340c9b2e75c5bccd69dc3', '3', '医生取消', 'rx_status', '待接收', 30, '0', '1', '2017-9-25 14:39:33', '1', '2017-9-25 14:39:33', '', '0');
